...
TOKEN_TEXT = {
    ...
    MV_DSTFIELD_IS_FRDLYTOUCHED_BY_PAWN : "MV_DSTFIELD_IS_FRDLYTOUCH_BY_PW",
    MV_DSTFIELD_IS_FRDLYTOUCHED_BY_OFFICER : "MV_DSTFIELD_IS_FRDLYTOUCH_BY_OFF",
    MV_DSTFIELD_IS_ENMYTOUCHED_BY_PAWN : "MV_DSTFIELD_IS_ENMYTOUCH_BY_PW",
    MV_DSTFIELD_IS_ENMYTOUCHED_BY_OFFICER : "MV_DSTFIELD_IS_ENMYTOUCH_BY_OFF",
