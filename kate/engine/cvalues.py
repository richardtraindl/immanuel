...
MV_IS_CASTLING                         = 0x800000000
MV_IS_PROMOTION                        = 0x400000000
MV_IS_CAPTURE                          = 0x200000000
MV_IS_ATTACK                           = 0x100000000
MV_IS_SUPPORT                          = 0x080000000
MV_IS_FLEE                             = 0x040000000
MV_IS_PROGRESS                         = 0x020000000

MV_PIECE_IS_PAWN                       = 0x008000000
MV_PIECE_IS_OFFICER                    = 0x004000000
MV_PIECE_IS_QUEEN                      = 0x002000000
MV_PIECE_IS_KING                       = 0x001000000
MV_DSTFIELD_IS_FRDLYTOUCHED_BY_PAWN    = 0x000800000
MV_DSTFIELD_IS_FRDLYTOUCHED_BY_OFFICER = 0x000400000
MV_DSTFIELD_IS_ENMYTOUCHED_BY_PAWN     = 0x000200000
MV_DSTFIELD_IS_ENMYTOUCHED_BY_OFFICER  = 0x000100000

CAPTURED_IS_PAWN                       = 0x000080000
CAPTURED_IS_OFFICER                    = 0x000040000
CAPTURED_IS_QUEEN                      = 0x000020000

ATTACKED_IS_PAWN                       = 0x000008000
ATTACKED_IS_OFFICER                    = 0x000004000
ATTACKED_IS_QUEEN                      = 0x000002000
ATTACKED_IS_KING                       = 0x000001000
ATTACKED_IS_ADD_ATT_FROM_PAWN          = 0x000000800
ATTACKED_IS_ADD_ATT_FROM_OFFICER       = 0x000000400
ATTACKED_IS_SUPP_BY_PAWN               = 0x000000200
ATTACKED_IS_SUPP_BY_OFFICER            = 0x000000100

SUPPORTED_IS_PAWN                      = 0x000000080
SUPPORTED_IS_OFFICER                   = 0x000000040
SUPPORTED_IS_QUEEN                     = 0x000000020
SUPPORTED_IS_ATT_FROM_PAWN             = 0x000000010
SUPPORTED_IS_ATT_FROM_OFFICER          = 0x000000008
SUPPORTED_IS_ADD_SUPP_BY_PAWN          = 0x000000004
SUPPORTED_IS_ADD_SUPP_BY_OFFICER       = 0x000000002
