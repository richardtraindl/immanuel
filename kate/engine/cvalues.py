...
TOKEN_TEXT = {
    ...
    MV_PIECE_IS_QUEEN : "",
    MV_PIECE_IS_KING : "",
    MV_DSTFIELD_IS_FRDLYTOUCHED_BY_PAWN : "",
    MV_DSTFIELD_IS_FRDLYTOUCHED_BY_OFFICER : "",
    MV_DSTFIELD_IS_ENMYTOUCHED_BY_PAWN : "",
    MV_DSTFIELD_IS_ENMYTOUCHED_BY_OFFICER : "",
    CAPTURED_IS_PAWN : "",
    CAPTURED_IS_OFFICER : "",
    ATTACKED_IS_PAWN : "",
    ATTACKED_IS_OFFICER : "",
    ATTACKED_IS_KING : "",
    ATTACKED_IS_ADD_ATT_FROM_PAWN : "",
    ATTACKED_IS_ADD_ATT_FROM_OFFICER : "",
    ATTACKED_IS_SUPP_BY_PAWN : "",
    ATTACKED_IS_SUPP_BY_OFFICER : "",
    SUPPORTED_IS_PAWN : "",
    SUPPORTED_IS_OFFICER : "",
    SUPPORTED_IS_ATT_FROM_PAWN : "",
    SUPPORTED_IS_ATT_FROM_OFFICER : "",
    SUPPORTED_IS_ADD_SUPP_BY_PAWN : "",
    SUPPORTED_IS_ADD_SUPP_BY_OFFICER : "" }
