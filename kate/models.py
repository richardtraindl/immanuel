...
class Match(models.Model):
    ...
    def writefield(self, x, y, value):
        idx = y*32 + x*4
        str_value = helper.reverse_lookup(cMatch.PIECES, value)
...
class Move(models.Model):
    ...
    captured_piece = models.PositiveSmallIntegerField(null=False, default=cMatch.PIECES['blk'])
    prom_piece = models.PositiveSmallIntegerField(null=False, default=cMatch.PIECES['blk'])
