...
urlpatterns = [
    ...
    url(r'^(?P<matchid>[0-9]+)/printmatch/$', views.print_match, name='printmatch'),
    url(r'^writematch/$', views.write_match, name='writematch'),    
    url(r'^(?P<matchid>[0-9]+)/analyze/$', views.analyze, name='analyze'),
    url(r'^(?P<matchid>[0-9]+)/(?P<threadidx>[0-9]+)/(?P<rcount>[0-9]+)/analyze/$', views.analyze, name='analyze'),
    url(r'^(?P<matchid>[0-9]+)/(?P<threadidx>[0-9]+)/(?P<rcount>[0-9]+)/replay/$', views.replay, name='replay'),
