...
################
    def do_move(self, dstx, dsty, prom_piece=PIECES['blk']):
        ...
        move = cMove(self.match, self.match.movecnt() + 1, cMove.TYPES['standard'], \
                     self.xpos, self.ypos, dstx, dsty, \
                     None, None, dstpiece, prom_piece, board.fifty_moves_count)
        ...
        if(self.piece == PIECES['wPw'] or 
           self.piece == PIECES['bPw'] or 
           dstpiece != PIECES['blk']):
            board.fifty_moves_count = 0
        else:
            board.fifty_moves_count += 1
...
################
    def undo_move(self, move):
        ...
        board.fifty_moves_count = move.fifty_moves_count
        return move
################
