...
def list_match_attributes(match):
    ...
    attributes.append(ClassAttr(match.board.fifty_moves_count, "board.fifty_moves_count"))
...
def prnt_matches_diff(match1, match2):
    ...
    if(match1.board.fifty_moves_count != match2.board.fifty_moves_count):
        print("fifty_moves_cnt " + str(match2.board.fifty_moves_count))
